 ...
 * 
 * Página de perfil del usuario con pestañas.
 * Conecta la lógica (usePerfil) con el diseño (componentes UI).
 * 
 * ✅ Buenas prácticas:
 * - Separación de lógica y diseño
 * - Uso de Tabs de shadcn/ui
      ...
      <Layout>
        <div className="min-h-[60vh] flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-[#6A757C] mt-4">Cargando tu perfil...</p>
          </div>
        </div>
      </Layout>
    );
              ...
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  <Avatar className="w-20 h-20 mx-auto ring-4 ring-[#7D5FFF]/20">
                    <AvatarFallback
                      className={`${getAvatarColor(user.fullName || "User")} text-white text-3xl font-bold`}
                    >
                      {getInitials(user.fullName || "Usuario")}
                    </AvatarFallback>
                  </Avatar>
                  <h3 className="font-bold text-[#303030] mt-2">{user.fullName}</h3>
                  <p className="text-sm text-[#6A757C]">{user.email}</p>
                </div>
          ...
          <div className="flex-1">
            <Tabs defaultValue="datos" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-6">
                ...
                <TabsTrigger value="pedidos">📦 Mis pedidos ({orders.length})</TabsTrigger>
              </TabsList>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-6">
                        <div>
                          ...
                          <p className="text-[#6A757C] text-sm">Actualiza tu información de contacto</p>
                        </div>
                      ...
                      <div className="flex items-center gap-4 mb-6">
                        <Avatar className="w-16 h-16 ring-2 ring-[#7D5FFF]/30">
                          <AvatarFallback
                            className={`${getAvatarColor(user?.fullName || "User")} text-white text-2xl font-bold`}
                          >
                            {getInitials(user?.fullName || "Usuario")}
                          </AvatarFallback>
                        </Avatar>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          />
                          <p className="text-xs text-[#6A757C] mt-1">ℹ️ El correo no se puede modificar</p>
                        </div>
                  ...
                  <Card className="border-2 border-[#FF6B81] shadow-lg hover:shadow-xl transition-shadow">
                    <CardContent className="p-6">
                      <div className="mb-6">
                        ...
                        <p className="text-[#6A757C] text-sm">Cambia tu contraseña para mantener tu cuenta segura</p>
                      </div>
                      ...
                      <form onSubmit={handlePasswordChange} className="space-y-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            required
                          />
                          <p className="text-xs text-[#6A757C] mt-1">ℹ️ Mínimo 8 caracteres, una mayúscula y un número</p>
                        </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-[#6A757C] text-sm">Historial de tus compras</p>
                      </div>
                      {orders.length > 0 && (
                    ...
                    {orders.length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <p className="text-[#6A757C] font-medium text-lg">No tienes pedidos aún</p>
                        <p className="text-sm text-[#6A757C] mt-1">Realiza tu primera compra en la tienda.</p>
